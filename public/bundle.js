...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function (_React$Component) {
	  ...
	  _createClass(Main, [{
	    key: 'loadRestaurantsFromServer',
	    value: function loadRestaurantsFromServer() {
	      $.ajax({
	    ...
	    key: 'restaurantSubmit',
	    value: function restaurantSubmit(restaurant) {
	    ...
	    value: function deleteRestaurant(restaurantId, event) {
	      $.ajax({
	        url: this.state.restaurantsUrl,
	        dataType: 'json',
	        type: 'DELETE',
	    ...
	    key: 'filter',
	    value: function filter(newText) {
	      this.setState({ filterText: newText });
	    }
	  }, {
	    key: 'filteredRestaurants',
	    value: function filteredRestaurants() {
	      var restaurants = this.state.restaurants,
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_restaurant_form2.default, {
	        ...
	        _react2.default.createElement(_restaurants_frame2.default, {
